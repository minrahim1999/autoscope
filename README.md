...
tests/
  web/          web test packages
  android/      Android test packages
  ios/          iOS test packages (requires a running WebDriverAgent)
  core/         desktop app internals (mocked, no browser/device/WDA required)
```
